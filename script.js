...
// Coba play otomatis saat halaman load (dengan muted dulu)
if (bgMusic) {
    bgMusic.muted = true;
    bgMusic.play().catch(e => console.log("Initial play with muted:", e));
}

// Start music saat user pertama kali berinteraksi
